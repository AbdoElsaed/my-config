...
beautiful.init("/home/apdo/.config/awesome/theme.lua")

-- define gaps
beautiful.useless_gap = 10
beautiful.gap_single_client = true

-- use nm-applet as a network manager
...
-- enable touchpad
local tpcommand = 'xinput set-prop "$(xinput list --name-only | grep -i touch)" "libinput Tapping Enabled" 1'
awful.spawn.easy_async_with_shell(tpcommand, function() end)
...
-- import battery-widget
local batteryarc_widget = require("awesome-wm-widgets.batteryarc-widget.batteryarc")
-- import cpu widget
-- local cpu_widget = require("awesome-wm-widgets.cpu-widget.cpu-widget")

-- import power option widget
...
globalkeys = gears.table.join(
    awful.key({ "Control", "Shift" }, "s", function () awful.util.spawn_with_shell("systemctl suspend") end),
